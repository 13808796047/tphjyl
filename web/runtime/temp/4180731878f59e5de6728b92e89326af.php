<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"/Users/sky/Desktop/code/yhyl/web/public/../application/index/view/report_manage/cash_list.html";i:1528683058;}*/ ?>
        ...
        <div class="list">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <?php if(($vo['state'] == 0)): ?> <?php echo $vo['amount']; else: ?> 0.00
                        <?php endif; ?>
                    </td>
                    <td>
                        <?php switch($vo['state']): case "0": ?>确认到帐<?php break; case "1": ?>用户申请<?php break; case "2": ?>已取消<?php break; case "3": ?>已支付<?php break; case "4": ?>提现失败<?php break; case "5": ?>后台删除<?php break; default: ?>提现失败
                        <?php endswitch; ?>
                    </td>
