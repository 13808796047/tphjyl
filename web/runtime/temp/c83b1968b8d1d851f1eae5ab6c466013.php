    ...
    <div class="main-section">
        <div class="left-aside">
            ...
            <div class="content">
                ...
                <?php if(strtotime($settings['activity_first_time'])<time() && strtotime($settings['activity_end_time']) >time()): ?>
                <div class="row">
                    <a href="./xiaofei" target="mainFrame">

                        <i class="arrow-right"></i>消费活动					</a>
                </div>
                <?php endif; if($settings['ChongZhiFanLiKaiGuan']== 1): ?>
                <div class="row">
                    <a href="./chongzhi" target="mainFrame">
                        <i class="arrow-right"></i>充值送礼</a>
                </div>
                <?php endif; if($settings['RiGongZiKaiGuan']== 1 && $user_rigongzi==true): ?>
                <div class="row">
