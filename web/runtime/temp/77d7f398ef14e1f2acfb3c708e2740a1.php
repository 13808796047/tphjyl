<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"/Users/sky/Desktop/code/yhyl/web/public/../application/index/view/report_manage/index.html";i:1530885691;s:77:"/Users/sky/Desktop/code/yhyl/web/public/../application/index/view/header.html";i:1531405841;s:77:"/Users/sky/Desktop/code/yhyl/web/public/../application/index/view/footer.html";i:1531405715;}*/ ?>
<!DOCTYPE html>
<html>
...
<!--<div class="container-fluid" >-->
    ...
    <!--<div class="tab-content" id="nav-tabContent">-->
        ...
        <!--<div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">4</div>-->
    <!--</div>-->
<!--</div>-->
    ...
    <div class="main-section">
        <div class="left-aside">
            ...
            <div class="content">
                <!-- menu title = 盈亏查询-->
                <div class="row ">
                    <a href="./reportlist.html" target="mainFrame">

                        <i class="arrow-right"></i>盈亏查询                 </a>
                </div>
                <!-- menu title = 帐变记录-->
                <div class="row ">
                    <a href="./orderslist.html" target="mainFrame">

                        <i class="arrow-right"></i>帐变记录					</a>
                </div>
                <!-- menu title = 充值记录-->
                <div class="row ">
                    <a href="./rechargelist.html" target="mainFrame">

                        <i class="arrow-right"></i>充值记录					</a>
                </div>
                <!-- menu title = 提现记录-->
                <div class="row ">
                    <a href="./cashlist.html" target="mainFrame">

                        <i class="arrow-right"></i>提现记录					</a>
                </div>
            </div>
        </div><!--menu-->
        ...
        <div class="right-aside">
            <div class="navigation">
                ...
                <span>&gt;</span>
                <!-- 帐变记录 -->
                <a href="#" class="navgiate1"><?php if((session('userData.type') == 1)): ?>盈亏查询<?php else: ?>帐变记录<?php endif; ?></a>

            </div><!--navigation-->
            <iframe style="min-height:600px;width:100%;height:100%;" src="<?php if((session('userData.type') == 1)): ?>./reportlist.html<?php else: ?>./orderslist.html<?php endif; ?>" allowtransparency="true"  name="mainFrame" width="100%" scrolling="yes" frameborder="0" id="mainFrame" border="0" noresize="noresize" framespacing="0"  style="height:100%"></iframe>
        </div>
    </div>
