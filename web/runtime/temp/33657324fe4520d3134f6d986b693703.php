...
<div id="wrap">
    ...
    <div class="main-section">
        ...
        <div class="right-aside">
            ...
            <iframe onload="setIframeHeight(this)" width="100%"
                    src="/recharge/<?php echo $page_url; ?>" allowtransparency="true" name="mainFrame" scrolling="no"
