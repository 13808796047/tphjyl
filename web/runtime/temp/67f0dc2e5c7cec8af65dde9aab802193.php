<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"/Users/sky/Desktop/code/yhyl/web/public/../application/index/view/activity/commission.html";i:1528683058;}*/ ?>
    ...
    <div class="main">
        <div class="section">
                ...
                <div class="step">
                    <div class="formTable">
                        <?php if($is_receive == 1): ?>
                            ...
                            <br />&emsp;<?php echo date('Y-m-d H:i:s'); elseif(date('H') < 9 || empty($coin_report)): ?>
                            &emsp;<span style="color:green; font-weight:bold">您的下級、下下級、下下下級用户昨日投注并未达标哦！请再接再厉！</span>
                            <br />&emsp;<?php echo date('Y-m-d H:i:s'); else: ?>
            ...
            <div class="content">
                ...
                <?php if(!empty($coin_report)): if(is_array($coin_report) || $coin_report instanceof \think\Collection || $coin_report instanceof \think\Paginator): $i = 0; $__LIST__ = $coin_report;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <td width="16%"><?php echo $vo['username']; ?></td>
                            <td width="16%" style="color: <?php if($vo['award_type'] == '消费'): ?>red<?php endif; ?>"><?php echo $vo['award_type']; ?></td>
                            <td width="16%"><?php echo $vo['award']; ?></td>
                            <td width="16%"><?php echo $vo['member_level']; ?></td>
                        </tr>
