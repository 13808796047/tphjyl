// jquery 1.9.1 uncompressed version...
! function(e, t) {
    function n(e) {
        var t = e.length,
            n = ue.type(e);
    ...
    function N(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++) r = e[a], r.style && (o[a] = ue._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && T(r) && (o[a] = ue._data(r, "olddisplay", S(r.nodeName)))) : o[a] || (i = T(r), (n && "none" !== n || !i) && ue._data(r, "olddisplay", i ? n : ue.css(r, "display"))));
    ...
    function k(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2) "margin" === n && (a += ue.css(e, n + Nt[o], !0, i)), r ? ("content" === n && (a -= ue.css(e, "padding" + Nt[o], !0, i)), "margin" !== n && (a -= ue.css(e, "border" + Nt[o] + "Width", !0, i))) : (a += ue.css(e, "padding" + Nt[o], !0, i), "padding" !== n && (a += ue.css(e, "border" + Nt[o] + "Width", !0, i)));
        return a
    }
    ...
    function B(e, t) {
        ue.each(t, function(t, n) {
            for (var r = (on[t] || []).concat(on["*"]), i = 0, o = r.length; i < o; i++)
    ...
    function P(e, t, n) {
        var r, i, o = 0,
            ...
            u = function() {
                if (i) return !1;
                for (var t = Kt || O(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; a < u; a++) l.tweens[a].run(o);
    ...
    function W(e, t, n) {
        ...
        if (o = g.length) {
            ...
            for (i = 0; i < o; i++) r = g[i], l = p.createTween(r, m ? s[r] : 0), h[r] = s[r] || ue.style(e, r), r in s || (s[r] = l.start, m && (l.end = l.start, l.start = "width" === r || "height" === r ? 1 : 0))
        }
    }
    ...
    function I(e, t) {
        var n, r = {
            ...
            i = 0;
        for (t = t ? 1 : 0; i < 4; i += 2 - t) n = Nt[i], r["margin" + n] = r["padding" + n] = e;
    ...
    ue.fn = ue.prototype = {
        ...
        var e, n, r, i, o, a, s = arguments[0] || {},
            ...
            l = arguments.length,
            c = !1;
        for ("boolean" == typeof s && (c = s, s = arguments[1] || {}, u = 2), "object" == typeof s || ue.isFunction(s) || (s = {}), l === u && (s = this, --u); u < l; u++)
    ...
    ue.Callbacks = function(e) {
            ...
            p = {
                ...
                remove: function() {
                    return l && ue.each(arguments, function(e, t) {
                        for (var r;
                            (r = ue.inArray(t, l, r)) > -1;) l.splice(r, 1), n && (r <= a && a--, r <= s && s--)
                    }), this
                },
                has: function(e) {
        ...
        when: function(e) {
            ...
            if (a > 1)
                for (t = new Array(a), n = new Array(a), r = new Array(a); i < a; i++) o[i] && ue.isFunction(o[i].promise) ? o[i].promise().done(l(i, r, o)).fail(u.reject).progress(l(i, n, t)) : --s;
                ...
                if (u && l.nodeType && (!e.button || "click" !== e.type))
                    for (; l != this; l = l.parentNode || this)
                        if (1 === l.nodeType && (l.disabled !== !0 || "click" !== e.type)) {
                            for (o = [], a = 0; a < u; a++) i = n[a], r = i.selector + " ", o[r] === t && (o[r] = i.needsContext ? ue(r, this).index(l) >= 0 : ue.find(r, this, null, [l]).length), o[r] && o.push(i);
                            o.length && s.push({
                                elem: l,
                                handlers: o
                            })
        ...
        function(e, t) {
                ...
                for (var t, n, r, i = e.length, o = C.relative[e[0].type], a = o || C.relative[" "], s = o ? 1 : 0, u = d(function(e) {
                    ...
                    if (n = C.relative[e[s].type]) c = [d(h(c), n)];
                        ...
                        if (n = C.filter[e[s].type].apply(null, e[s].matches), n[P]) {
                            ...
                            return m(s > 1 && h(c), s > 1 && p(e.slice(0, s - 1)).replace(ae, "$1"), n, s < r && y(e.slice(s, r)), r < i && y(e = e.slice(r)), r < i && p(e))
                        }
                        c.push(n)
                    }
                return h(c)
            ...
            E = a.isXML = function(e) {
                ...
                return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, H = r.documentElement, q = E(r), W.tagNameNoComments = o(function(e) {
                    ...
                    if (typeof t.getElementsByName !== V) return t.getElementsByName(name)
    ...
    ue.fn.extend({
        find: function(e) {
            ...
            for (n = [], t = 0; t < i; t++) ue.find(e, this[t], n);
        ...
        closest: function(e, t) {
            for (var n, r = 0, i = this.length, o = [], a = ze.test(e) || "string" != typeof e ? ue(e, t || this.context) : 0; r < i; r++)
    ...
    at.optgroup = at.option, at.tbody = at.tfoot = at.colgroup = at.caption = at.thead, at.th = at.td, ue.fn.extend({
        ...
        html: function(e) {
            return ue.access(this, function(e) {
                ...
                if ("string" == typeof e && !et.test(e) && (ue.support.htmlSerialize || !Ye.test(e)) && (ue.support.leadingWhitespace || !Je.test(e)) && !at[(Qe.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace(Ge, "<$1></$2>");
                    try {
                        for (; r < i; r++) n = this[r] || {}, 1 === n.nodeType && (ue.cleanData(b(n, !1)), n.innerHTML = e);
                        n = 0
                    } catch (o) {}
                }
        ...
        domManip: function(e, n, r) {
            ...
            var i, o, a, s, u, l, c = 0,
                ...
                y = e[0],
                v = ue.isFunction(y);
            if (v || !(f <= 1 || "string" != typeof y || ue.support.checkClone) && nt.test(y)) return this.each(function(i) {
                var o = p.eq(i);
                v && (e[0] = y.call(this, i, n ? o.html() : t)), o.domManip(e, n, r)
            });
            if (f && (l = ue.buildFragment(e, this[0].ownerDocument, !1, this), i = l.firstChild, 1 === l.childNodes.length && (l = i), i)) {
                for (n = n && ue.nodeName(i, "tr"), s = ue.map(b(l, "script"), h), a = s.length; c < f; c++) o = l, c !== m && (o = ue.clone(o, !0, !0), a && ue.merge(s, b(o, "script"))), r.call(n && ue.nodeName(this[c], "table") ? d(this[c], "tbody") : this[c], o, c);
                if (a)
                    for (u = s[s.length - 1].ownerDocument, ue.map(s, g), c = 0; c < a; c++) o = s[c], rt.test(o.type || "") && !ue._data(o, "globalEval") && ue.contains(u, o) && (o.src ? ue.ajax({
                        url: o.src,
                        type: "GET",
                        dataType: "script",
                        async: !1,
        ...
        buildFragment: function(e, t, n, r) {
            ...
            for (s && d.removeChild(s), ue.support.appendChecked || ue.grep(b(h, "input"), x), g = 0; o = h[g++];)
                if ((!r || ue.inArray(o, r) === -1) && (a = ue.contains(o.ownerDocument, o), s = b(d.appendChild(o), "script"), a && m(s), n))
    ...
    ue.fn.extend({
        css: function(e, n) {
            return ue.access(this, function(e, n, r) {
                var i, o, a = {},
                    s = 0;
                if (ue.isArray(n)) {
                    for (o = ct(e), i = n.length; s < i; s++) a[n[s]] = ue.css(e, n[s], !1, o);
                    return a
                }
        ...
        ue.cssHooks[t] = {
            get: function(e, n, r) {
                if (n) return 0 === e.offsetWidth && gt.test(ue.css(e, "display")) ? ue.swap(e, wt, function() {
                    return E(e, t, r)
                }) : E(e, t, r)
            },
            set: function(e, n, r) {
        ...
        ue.support.reliableMarginRight || (ue.cssHooks.marginRight = {
            ...
            ue.cssHooks[t] = {
                get: function(e, n) {
                    if (n) return n = ft(e, t), vt.test(n) ? ue(e).position()[t] + "px" : n
                }
            }
        })
        ...
        ue.cssHooks[e + t] = {
            expand: function(n) {
                for (var r = 0, i = {}, o = "string" == typeof n ? n.split(" ") : [n]; r < 4; r++) i[e + Nt[r] + t] = o[r] || o[r - 2] || o[0];
                return i
            }
    ...
    ue.ajaxSetup({
        ...
        if (u || "jsonp" === n.dataTypes[0]) return o = n.jsonpCallback = ue.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, u ? n[u] = n[u].replace(Vt, "$1" + o) : n.jsonp !== !1 && (n.url += (qt.test(n.url) ? "&" : "?") + n.jsonp + "=" + o), n.converters["script json"] = function() {
