...
exports.cp=[
   {    type:43,
        ...
        option:{
            hostname:"www.tpppay.cn", //皇家
            // hostname:"yhyl19.com", //银河
            // hostname:"www.yhyl.com", //本地
            port: 80,
            timeout:10000,
            method: 'GET',
            path: '/getqq', //'/time.json'//  // Info0 定义在D:\webroot\lafei\Application\Home\Controller\WufencaiController.class.php
            // path: '/index.php?s=/home/kai/getQQData', //'/time.json'//  // Info0 定义在D:\webroot\lafei\Application\Home\Controller\WufencaiController.class.php
            headers:{
