...
function lotteryDraw() {
    var sql="select b.username,b.id,b.playedId,b.weiShu,b.actionNum,b.actionData,b.type,b.actionNo,d.data,b.zjCount,b.bonus  from gygy_bets as b " +
        "inner join gygy_data as d on b.type=d.type and b.actionNo=d.number " +
        "where b.isDelete=0 and b.lotteryNo='' and b.kjTime < (UNIX_TIMESTAMP() - 65) limit 800";
    console.log(sql);
    var client= createMySQLClient();
