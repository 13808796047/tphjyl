!
    function(e, t, a, n) {
        var r, i = {
                name: t,
                basePath: "../static/todo/js/game/bjpk10/",
                baseNamespace: "phoenix.Games.SSCBJPK10.",
                selectBallNum: 0,
                limitBonus: 10
            },
            o = {
                ...
                getGameConfig: function() {
                    return e.Games.SSCBJPK10.Config
                },
                ...
                getHTML: function() {
                    ...
                    e.defConfig.selectBallNum == a && Games.SSCBJPK10.getInstance()["liangmianpan.liangmian.guanyahezhi"].uploadHtmlSet() && t
                },
        ...
        l.defConfig = i,
            ...
            e.Games[t] = l
    } (phoenix, "SSCBJPK10", phoenix.Game),
    function(e, t, a, n) {
        var r, i = {},
            o = e.Games,
            l = {
            ...
            u = {
                ...
                updateTableNumber: function() {
                    ...
                    m > 0 && (e = c.getNormalRowTable().find("tr"), t = c.getAdvancedRowTable().find("tr"), o = c.getStartNumberIndexByNumber(a), e.each(function(e) {
                        return 0 == e || (n = $(this), r = n.find(".trace-row-number"), i = n.find(".trace-row-time"), multipleDom = n.find(".trace-row-multiple"), a = r.text().replace(/[^\d]/g, ""), s = n.find(".text-center"), n.find(".trace-row-multiple").removeAttr("disabled"), void(o + 1 < m && (p = u[o + 1].number == d ? f: "", r.html(u[o + 1].number + p), multipleDom.text("1"), i.text(u[o + 1].time), s.html("").html(e), g = r.text().substr(0, 6), o++)))
                ...
                trace_advanced_fanbei_a: function(e) {
                    ...
                    for (o.push(r.defConfig.dataRowHeader), t = r.getStartNumberIndexByNumber(T), h = t, s += h, a = r.getStartNumberByIndex(h); h < s; h++) {
                        if (y <= 0 && (y = d, g *= f), y--, g > u && (l.getCurrentGameMessage().show({
                                type: "normal",
                ...
                trace_advanced_fanbei_b: function() {
                    var e, t, a, n = this,
                        ...
                        b = "";
                    for (i.push(n.defConfig.dataRowHeader), e = n.getStartNumberIndexByNumber(y), u = e, o += u, t = n.getStartNumberByIndex(u); u < o && (c = u < m + e ? d > s ? s: d: p > s ? s: p, t = n.getStartNumberByIndex(u), t.number); u++) h = t.number,
                    h == g && (h += f),
                        b = u + 1,
                        a = {
                            No: b,
                    ...
                    for (o.push(r.defConfig.dataRowYingliHeader), t = r.getStartNumberIndexByNumber(x), p = t, s += p, a = r.getStartNumberByIndex(p); p < s; p++) {
                        if (b = 0, T = 0, y = 1, $.each(v,
                                function(e) {
                                    ...
                                    T += o,
                                        b += i
                                }), y = r.getMultipleByMoney(h, g, b, C, d), y < 0) return void l.getCurrentGameMessage().show({
                            type: "normal",
                            closeText: translate.Comfirm,
                            closeFun: function() {
                                this.hide()
                        ...
                        if (b *= y, C += b, T = h * y - C, D = T / C, a = r.getStartNumberByIndex(p), !a.number) break;
                        S = a.number,
                        S == w && (S += M),
                            N = p + 1,
                            n = {
                ...
                trace_advanced_yingli_b: function(e) {
                    ...
                    for (o.push(r.defConfig.dataRowYingliHeader), t = r.getStartNumberIndexByNumber(N), p = t, s += p, a = r.getStartNumberByIndex(p); p < s; p++) {
                        ...
                        if (T *= b, D += T, w = v * b - D, M = w / D, a = r.getStartNumberByIndex(p), !a.number) break;
                        G = a.number,
                        G == S && (G += x),
                            k = p + 1,
                            n = {
                    ...
                    for (o.push(r.defConfig.dataRowYingliHeader), t = r.getStartNumberIndexByNumber(S), p = t, s += p, a = r.getStartNumberByIndex(p); p < s; p++) {
                        if (b = 0, T = 0, y = 1, $.each(v,
                                function(e) {
                                    ...
                                    T += o,
                                        b += i
                                }), y = r.getMultipleByYinglilv(g, h, b, C, d), y < 0) return void l.getCurrentGameMessage().show({
                            type: "normal",
                            closeText: translate.Comfirm,
                            closeFun: function() {
                                this.hide()
                        ...
                        if (b *= y, C += b, T = h * y - C, a = r.getStartNumberByIndex(p), !a.number) break;
                        M = a.number,
                        M == D && (M += w),
                            G = p + 1,
                            n = {
                    ...
                    for (o.push(r.defConfig.dataRowYingliHeader), t = r.getStartNumberIndexByNumber(N), p = t, s += p, a = r.getStartNumberByIndex(p); p < s; p++) {
                        if (D = 0, M = 0, C = 1, $.each(T,
                                function(e) {
                                    ...
                                    M += o,
                                        D += i
                                }), y = p < g + t ? f: h, C = r.getMultipleByYinglilv(y, b, D, w, d), C < 0) return void l.getCurrentGameMessage().show({
                            type: "normal",
                            closeText: translate.Comfirm,
                            closeFun: function() {
                                this.hide()
        ...
        var r = {
            ...
            s = {
                ...
                checkResult: function(e, t) {
                    for (var a = t.length - 1; a >= 0; a--) if (t[a].join("") == e.join("")) return ! 1;
                    return ! 0
                },
                ...
                checkBallGroup: function(e) {
                    for (var t = e.length - 1; t >= 0; t--) if (Number(e[t]) < 1 || Number(e[t]) > 10) return ! 0;
                    return ! 1
                },
                checkBallIsComplete: function(e) {
                    var t = this,
                        a = 0,
                        n = [];
                    for (t.allData = [], t.correctData = [], t.sameData = [], t.errorData = [], t.tempData = [], n = t.iterator(t.filterLotters(e), t.defConfig.filtration) || []; a < n.length; a++) t.checkSingleNum(n[a]) ? (t.checkResult(n[a], t.tempData) ? t.tempData.push(n[a]) : t.checkResult(n[a], t.sameData) && t.sameData.push(n[a]), t.correctData.push(n[a])) : t.checkResult(n[a], t.errorData) && t.errorData.push(n[a]),
                    t.checkResult(n[a], t.allData) && t.allData.push(n[a]);
                    return t.tempData.length > 0 ? (t.isBallsComplete = !0, t.isFirstAdd ? t.correctData: t.tempData) : (t.isBallsComplete = !1, [])
                },
                checkSingleNum: function(e) {
                    ...
                    return $.each(e,
                        function() {
                            if (!t.defConfig.checkNum.test(this)) return a = !1,
                                !1
                        }),
                        a
                },
                ...
                removeOrderError: function() {
                    var e = this,
                        ...
                        a = 0,
                        n = e.tempData.length;
                    for (a = 0; a < n; a++) t[a] = e.tempData[a].join(" ");
                    if (!e.firstfocus) return t = $.trim(t.join(",")),
                        e.errorDataTips(),
                        e.replaceText(t),
                        e.errorData = [],
                        e.sameData = [],
                        ...
                        e.updateData(),
                        "" == $.trim(t) ? void e.showNormalTips() : void 0
                },
                ...
                removeOrderAll: function() {
                    var e = this;
                    e.firstfocus || (e.replaceText(" "), e.sameData = [], e.allData = [], e.tempData = [], e.correctData = [], o.getCurrentGameStatistics().reSet(), e.showNormalTips())
                },
                ...
                makePostParameter: function(e, t) {
                    for (var a = [], e = t.lotterys, n = 0; n < e.length; n++) a = a.concat(e[n].join(" "));
                    return a.join(" , ")
                },
                makeSubmitParameter: function(e, t) {
                    for (var a = 0,
                             e = t.lotterys,
                             n = $.extend(!0, [], e); a < e.length; a++) n[a] = n[a].join(" ");
                    return n.join("&")
                },
                getLottery: function() {
                    var e = this,
                ...
                getOriginal: function() {
                    var e = this,
                        ...
                        a = t.length,
                        n = t[0].length;
                    for (i = 0, j = 0, row = [], tempData = this.tempData, data = e.getHtml(), result = []; i < a; i++) {
                ...
                getHTML: function() {
                    ...
                    return e.push('<div class="balls-import clearfix">'),
                        ...
                        e.push("</form>"),
                        e.push('<div class="panel-select" style="height:160px"><iframe style="width:100%;height:100%;border:0 none;background-color:#F9F9F9;" class="content-text-balls"></iframe></div>'),
