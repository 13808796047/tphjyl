...
exports.cp=[
    {   type:39,
		...
		option:{//时间执行配置
			...
			timeout:10000,
			method: 'GET',
			path: '/getinfo?type=39', //'/time.json'//  // Info0 定义在D:\webroot\lafei\Application\Home\Controller\WufencaiController.class.php 
			headers:{
...
{   
	...
	var num ="";
	for(var i=0;i<=100;i++){
		rnd = Min + Math.floor(Math.random()*(Max))
