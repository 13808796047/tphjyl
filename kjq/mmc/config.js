...
exports.cp=[
	{   type:36,
		...
		option:{//时间执行配置
			...
			timeout:10000,
			method: 'GET',
			path: '/getinfo?type=36', //'/time.json'//  // Info0 定义在D:\webroot\lafei\Application\Home\Controller\WufencaiController.class.php 
			headers:{
...
/* 	var jd = JSON.parse(str);
	...
	console.log(" ** 开奖间隔 **："+kjdq);
	console.log(" ** 开奖计数 **："+kjjs);
