...
exports.ssczx10=function(bet, kj){
	...
	if(count3==3 && count2==2)
	{
		...
		{
			return bet.split(",")[1].split('').filter(function(v){return second.indexOf(v)!=-1}).length;
		}
	}
	return 0;
}
...
//时时彩任选玩法单式 开始
//任选二直选单式
exports.Rx2ZhixD=function(bet, kj, w){
	kj=kj.split(',');
	...
	return bet.split(" ").filter(function(v){return kj.indexOf(v)!=-1}).length;
}

//任选二组选单式
exports.Rx2ZuxD=function(bet, kj, w){
	kj=kj.split(',');
	[16, 8, 4, 2, 1].forEach(function(v, i){
		if((w&v)==0) delete kj[i];
	});
	...
	kj = permutation(kj,2).map(function(v){ return v.join("");}).join(',');
	
	/*bet=bet.split(' ').map(function(b){
		b=b.split('');
		b = permutation(b,2).map(function(v){ return v.join("");})	
		return b.join(' ');
	}).join(' ');*/
	return bet.split(' ').filter(function(v){return kj.indexOf(v) > -1 ;}).length;
}
...
//sxwfR3d 任选三直选单式
exports.Rx3ZhixD=function(bet, kj, w){
	kj=kj.split(',');
	[16, 8, 4, 2, 1].forEach(function(v, i){
		if((w&v)==0) delete kj[i];
	});
...
//任选四直选单式
exports.Rx4ZhixD=function(bet, kj, w){
	kj=kj.split(',');
	[16, 8, 4, 2, 1].forEach(function(v, i){
		if((w&v)==0) delete kj[i];
	});
...
exports.sxwfZ3f=function(bet, kj){
	kj = kj.removeFromList(',', 5, 5);
	return fs(bet, kj.removeFromList(',', 1, 1));
}

// 中三单式
exports.sxwfZ3d=function(bet, kj){
	kj = kj.removeFromList(',', 5, 5);
	return ds(bet, kj.removeFromList(',', 1,1));
}
...
exports.sxzxZ3z3=function(bet, kj){
	kj = kj.removeFromList(',', 5, 5);
	return z3(bet, kj.removeFromList(',', 1, 1));
}

// 中三组六
exports.sxzxZ3z6=function(bet, kj){
	kj = kj.removeFromList(',', 5, 5);
	return z6(bet, kj.removeFromList(',', 1, 1));
}
 ...
 * @returns {Number} 中奖注数
 */
exports.bdwH31=function(bet, kj){
    kj=kj.substr(4,5);
    var betnum = 0;
    //豹子不中奖
	if(kj.match(/^(\d),\1,\1/)) return betnum;
 ...
 * @returns {Number} 中奖注数
 */
exports.bdwZ31=function(bet, kj){
    kj=kj.substr(2,5);
    var betnum = 0;
    //豹子不中奖
    if(kj.match(/^(\d),\1,\1/)) return betnum;
 ...
 * @returns {Number} 中奖注数
 */
exports.bdwQ31=function(bet, kj){
    kj=kj.substr(0,5);
    var betnum = 0;
    //豹子不中奖
    if(kj.match(/^(\d),\1,\1/)) return betnum;
 ...
 * @returns {Number} 中奖注数
 */
exports.bdwQ21=function(bet, kj){
    kj=kj.substr(0,3);
    ////对子不中奖
    var betnum = 0;
    if(checkRepet(kj)) return betnum;
 ...
 * @returns {Number} 中奖注数
 */
exports.bdwH21=function(bet, kj){
    kj=kj.substr(6,3);
    ////对子不中奖
    var betnum = 0;
    if(checkRepet(kj)) return betnum;
...
exports.gd11x5Q2z=function(bet, kj){
	var num = 0;
	kj =  kj.substr(0,5);
	bet.split(',').forEach(function(v,k){
		num += zx(v,kj);
	});
	return num;
...
// 前三不定位
exports.gd11x5bddQ3=function(bet, kj){
	kj=kj.substr(0,8);
	bet=bet.split(',').filter(function(v){
		return kj.indexOf(v)!=-1;
	});
...
//前三组六单式
exports.Q3z6d = function(bet, kj){
	kj=kj.substr(0,5);
	var l = 0;
	bet.split(' ').forEach(function(v, i){
		l = l + z6(v,kj);
	});
	return l;
}
...
// 四星组24
exports.ssc4XZ24=function(bet, kj){
	var w = 15;
	kj=kj.split(',');
	[16, 8, 4, 2, 1].forEach(function(v, i){
		if((w&v)==0) delete kj[i];
...
// 四星组12
exports.ssc4XZ12=function(bet, kj){
	var w = 15;
	kj=kj.split(',');
	[16, 8, 4, 2, 1].forEach(function(v, i){
		if((w&v)==0) delete kj[i];
...
// 四星组6
exports.ssc4XZ6=function(bet, kj){
	var w = 15;
	kj=kj.split(',');
	[16, 8, 4, 2, 1].forEach(function(v, i){
		if((w&v)==0) delete kj[i];
...
// 四星组4
exports.ssc4XZ4=function(bet, kj){
	var w = 15;
	kj=kj.split(',');
	[16, 8, 4, 2, 1].forEach(function(v, i){
		if((w&v)==0) delete kj[i];
...
function rx(bet, kj, num){
	...
	if(m=bet.match(reg)){
		...
		if(bet.indexOf(',') > -1){
			var l = 0;
			bet.split(',').forEach(function(idx,v){
				l = l +  combine(idx.split(' '), num)
				.filter(function(v){
					if(num<5){
						return v.every(function(c){
							return kj.indexOf(c)!=-1;
